...
const Project = ({ image, title, description, site, github }) => {
  ...
  return (
    <div>
        <article className='border-2 border-purple-800 rounded-md p-4 h-96 flex flex-col justify-between'>
            <div>
                <div className='border-2 border-gray-400 mb-4 rounded-md'>
                    <img src={image} alt='project thumbnail' className='basis-1/4 object-cover'></img>
                </div>
