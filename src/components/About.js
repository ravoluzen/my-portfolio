  ...
  return (
    ...
    transition={{ delay: 0.3 }}>
        <article className='grid grid-cols-1 md:items-center md:w-2/5 md:p-2'>
            ...
            <br></br>
            <p className='text-sm'>Hit me up on <a href='https://twitter.com/ravoluzen' taregt='_blank.' className='underline decoration-green-500 decoration-2 hover:decoration-purple-600'>Twitter</a> or <a href='https://www.linkedin.com/in/raj-shankar-tiwary-053b86189/' taregt='_blank.' className='underline decoration-green-500 decoration-2 hover:decoration-purple-600'>Linkedin</a>.</p>
            <p className='text-sm'>Or send a <a href='mailto: rajshankartiwary@gmail.com' taregt='_blank.' className='underline decoration-green-500 decoration-2 hover:decoration-purple-600'>mail</a>.</p>
            <br></br>
